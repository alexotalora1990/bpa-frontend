      ...
      <q-dialog v-model="alert" persistent>
        <q-card class="" style="width: 700px">
          ...
          <q-input
            ...
            class="q-my-md q-mx-md"
            type="text"
            :rules="limitesRules.ciudad"
            hide-bottom-space
          />
          <q-input
            outlined
            v-model="limites.norte"
            label="Límite Norte"
            class="q-my-md q-mx-md"
            type="text"
            :rules="limitesRules.norte"
            hide-bottom-space
          />
          <q-input
            outlined
            ...
            class="q-my-md q-mx-md"
            type="text"
            :rules="limitesRules.sur"
            hide-bottom-space
          />
          <q-input
            outlined
            v-model="limites.este"
            label="Límite Este"
            class="q-my-md q-mx-md"
            type="text"
            :rules="limitesRules.este"
            hide-bottom-space
          />
          <q-input
            outlined
            v-model="limites.oeste"
            label="Límite Oeste"
            class="q-my-md q-mx-md"
            type="text"
            :rules="limitesRules.oeste"
            hide-bottom-space
          />
...
const ubicacionRules = [
  isRequired("La ubicación es requerida"),
  minLength(3, "La ubicación debe tener al menos 3 caracteres"),
];
const areaRules = [
  isRequired("El área es requerida"),
  minLength(3, "El área debe tener al menos 3 caracteres"),
];

const limitesRules = ["norte", "sur", "este", "oeste"].reduce((acc, dir) => {
  acc[dir] = [
    isRequired(`El límite ${dir} es requerido`),
    minLength(3, `El límite ${dir} debe tener al menos 3 caracteres`),
  ];
  return acc;
}, {});
