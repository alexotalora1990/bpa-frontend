<template>
    <div style="height: 100vh; overflow-y: auto;">
        ...
        <div style="display: flex; justify-content: center">
            <q-table title="Fertilización" title-class="text-green text-weight-bolder text-h5" table-header-class="text-black"
...
import { useFertilizacionStore } from "../store/fertilizacion.js";
