<template>
    <div style="height: 100vh; overflow-y: auto;">
        <div style="margin-left: 5%; margin-right: 5%; display: flex; align-items: center;">
            <q-btn color="red" class="q-my-md q-ml-md" @click="abrir()">Crear analisisSuelo</q-btn>
                ...
                <q-card class="" style="width: 700px">
                    <q-card-section style="background-color: #a1312d; margin-bottom: 20px">
                        <div class="text-h6 text-white">
                            {{ accion == 1 ? "Crear analisisSuelo" : "Editar AnalisisSuelo" }}
                        </div>
                    </q-card-section>
                    <q-select outlined v-model="idParcela" label="Seleccione una Parcela" :options="options"
                        ...
                        <q-select outlined v-model="idEmpleado" label="Seleccione un Empleado" :options="options"
                        class="q-my-md q-mx-md"  @filter="filterFn"  hide-bottom-space/>
                    <q-input outlined v-model="muestra" label="Muestra" class="q-my-md q-mx-md" type="text"
                        :rules="nombreRules" hide-bottom-space />
                    <q-input outlined v-model="cultivo" label="Cultivo" class="q-my-md q-mx-md" type="text"
                        :rules="rutRules" hide-bottom-space />
                    <q-input outlined v-model="laboratorio" label="Laboratorio" class="q-my-md q-mx-md"
                    ...
                    <q-input outlined v-model="resultados" label="Resultados" class="q-my-md q-mx-md"
                        type="text" :rules="ubicacionRules" hide-bottom-space />
...
import { useAnalisisSueloStore } from "../store/analisisSuelo.js";
